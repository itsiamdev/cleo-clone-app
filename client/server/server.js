...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-D9JIKeqW.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CNPwvAlB.js"),
...
var ROUTER_BASEPATH = "cleo-clone-app";
var SERVER_FN_BASE = "/cleo-clone-app/_serverFn/";
