import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-vc6YuugH.js";
import "node:events";
...
function Navbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "flex items-center gap-2 font-display font-bold tracking-tight text-lg", children: "cleo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-8 text-sm text-white/70", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#product", className: "hover:text-white transition-colors", children: "Product" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#features", className: "hover:text-white transition-colors", children: "Features" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#pricing", className: "hover:text-white transition-colors", children: "Pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#about", className: "hover:text-white transition-colors", children: "About" })
        ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { style: { y, opacity, scale: scale2 }, className: "relative z-10 text-center px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-[0.4em] uppercase text-white/50 border border-white/15 rounded-full px-4 py-1.5", children: "cleo" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-[14vw] md:text-[9rem] lg:text-[12rem] leading-[0.85] font-bold tracking-tighter", children: headline.map((word, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block overflow-hidden align-bottom mr-[0.18em]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.span,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "Download free" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 bg-white/0 group-hover:bg-white/20 transition-colors" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Marquee() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-white/10 py-8 overflow-hidden bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex marquee-track whitespace-nowrap", children: all.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-10 px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl md:text-5xl font-bold tracking-tight text-white/80", children: t }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-white/30" })
  ] }, i)) }) });
}
...
function FeatureSection({ eyebrow, title, description, visual, reverse, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref, className: "relative py-32 md:py-48 px-6 md:px-10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs tracking-[0.3em] uppercase text-white/50 mb-6", children: [
                "0",
                index,
                " — ",
                eyebrow
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-5xl md:text-7xl font-bold tracking-tight leading-[0.95] mb-8", children: title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/60 max-w-md leading-relaxed", children: description })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { y }, className: "relative", children: visual })
      ]
    }
  ) });
}
function PhoneMock({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full rounded-[2.4rem] bg-black overflow-hidden relative grain", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-32 h-7 bg-black rounded-b-3xl z-20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-4 bg-zinc-900 rounded-full" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4 z-20 text-[10px] tracking-[0.3em] uppercase text-white/50", children: "cleo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-14 px-5 pb-5 h-full flex flex-col", children })
      ] })
    }
  );
}
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative border-t border-white/10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 md:px-10 pt-24 pb-12 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.h2,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-white/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 font-display font-bold tracking-tight", children: "cleo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-white transition-colors", children: "Contact" })
      ] }),
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-black text-white selection:bg-white selection:text-black", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Marquee, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureSection, { index: 1, eyebrow: "Autopilot", title: "Saves money while you sleep.", description: "We move the right amount, on the right day, to the right place. You wake up with more. That's it.", visual: /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneMock, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBubble, { delay: 0.1, children: "You hit your savings goal 3 days early. Casual flex." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBubble, { from: "me", delay: 0.3, children: "wait fr??" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBubble, { delay: 0.5, children: "+£127 moved to savings this week. You're welcome." })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureSection, { index: 2, reverse: true, eyebrow: "Money IQ", title: "Reads your spending. Speaks the truth.", description: "Real conversations about where your money actually goes. No sugar coating, no spreadsheets.", visual: /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneMock, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBubble, { from: "me", delay: 0.1, children: "how bad was last weekend" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBubble, { delay: 0.3, children: "£94 on takeout in 48 hours. We need to talk." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatBubble, { delay: 0.6, children: "Want me to set a delivery limit before Friday?" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureSection, { index: 3, eyebrow: "The Card", title: "A black card with a brain.", description: "Built-in budgets, instant insights, and zero hidden fees. Tap, and we handle the rest.", visual: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { whileHover: {
      rotate: -4,
      scale: 1.04
    }, transition: {
      type: "spring",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs tracking-[0.3em] uppercase text-white/50", children: "cleo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-7 rounded-md bg-gradient-to-br from-white/30 to-white/10" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-mono tracking-widest text-white/80 mb-3", children: "•••• •••• •••• 0427" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[10px] uppercase tracking-widest text-white/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Cardholder" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "04/30" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-32 px-6 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-5xl md:text-6xl font-bold text-white", children: s.n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.3em] mt-2", children: s.l })
      ] }, s.l)) })
    ] }),
